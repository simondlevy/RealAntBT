...
After cloning this repository (RealAntBT) onto your host computer (desktop or
laptop), you should only need to edit the
...
Pi, power it up with the battery, wait 30 seconds or so for it to boot up, and run the 
